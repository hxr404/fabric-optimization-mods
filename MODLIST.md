...
| Fast Chest | Removes dynamic models from chests and makes them render as static chunk geometry. (This removes their lid opening animation) | FakeDomi | --- | --- | --- | https://www.curseforge.com/minecraft/mc-mods/fastchest |
...
| Fast Furnace | --- | Tfarcenim | --- | --- | --- | https://www.curseforge.com/minecraft/mc-mods/fast-furnace-for-fabric |
...
| Name | Description | Developer | Stable | Dangerous | Incompatibilities | Link |
| --- | --- | --- | --- | --- | --- | --- |
| Fabric Carpet, Carpet TIS Addition, Carpet Addons | --- | gnembon, TISUnion, whoImT | --- | --- | --- | https://github.com/gnembon/fabric-carpet https://github.com/TISUnion/Carpet-TIS-Addition https://github.com/whoImT/carpet-addons |
| Fabric Zero (Discontinued) | Compability enhancement mod and can slightly improve performance | Fox2Code | --- | --- | None | https://www.curseforge.com/minecraft/mc-mods/fabric-zero |
| FoamFix (outdated) | Outdated do not use | asiekierka | --- | --- | --- | https://www.curseforge.com/minecraft/mc-mods/foamfix-optimization-mod |
